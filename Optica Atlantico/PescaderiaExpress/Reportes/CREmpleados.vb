...
Public Class CREmpleados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PescaderiaExpress.CREmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCREmpleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CREmpleados = New CREmpleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
