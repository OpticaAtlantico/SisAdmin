...
Public Class CRVentaLista
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PescaderiaExpress.CRVentaLista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVentaLista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVentaLista = New CRVentaLista()
        rpt.Site = Me.Site
        Return rpt
    End Function
