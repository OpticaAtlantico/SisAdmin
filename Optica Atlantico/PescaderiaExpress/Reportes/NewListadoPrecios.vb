...
Public Class NewListadoPrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MarSoft.NewListadoPrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNewListadoPrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NewListadoPrecios = New NewListadoPrecios()
        rpt.Site = Me.Site
        Return rpt
    End Function
